      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">{{ name }} | 奥特信息 | - {{ userInfo.departmentName }}</p>
            <!-- 下面为原始方式 这里可以使用另一种方式 -->
            <!-- <p class="lastChild">{{ name }} | 奥特信息 | - {{ $store.state.user.userInfo.departmentName }}</p> -->
...
import Radar from './components/radra.vue'
